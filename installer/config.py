...
def build_next_steps(
    ...
    lines.append("Note: maildata/ is written by a container running as root, so files are")
    lines.append("root-owned. The `primitive` CLI reads them without sudo; direct cat/rm/grep")
    lines.append("needs sudo.")
    lines.append("")
